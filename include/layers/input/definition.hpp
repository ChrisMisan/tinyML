...
namespace tinyML
{
    class input_layer_definition_t
        : public base_layer_definition_t
    {
    public:
        activation_f_t activation_f;
    public:
        constexpr input_layer_definition_t(size_t output_size, const activation_f_t& activation_f) noexcept
            : base_layer_definition_t(output_size)
            , activation_f(activation_f)
        { }
    public:
        ~input_layer_definition_t() override = default;
    public:
